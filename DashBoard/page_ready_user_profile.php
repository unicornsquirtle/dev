...
<div id="page-content">
    ...
    <div class="content-header content-header-media">
        <div class="header-section">
            ...
            $filename = "upload/{$_GET['username']}.png";

            if (file_exists($filename)) {
                echo $filename;
            } else {
                echo "upload/icon114.png";
            }
            }
            else{
            ...
            ?>" alt="Avatar" class="pull-right img-circle">
            <h1><?php
               echo $name;
                ?><br><small><?php
                if (isset($_GET['username'])) {
...
$query="SELECT shortinfo FROM $tbl_name WHERE username='$myusername'";
        ...
        <div class="col-md-6 col-lg-5">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2>About <strong><?php echo $name
                            ?></strong> <small>&bull; <i class="fa fa-file-text text-primary"></i> <a href="javascript:void(0)" data-toggle="tooltip" title="Download Bio in PDF">Bio</a></small></h2>
                </div>
                <!-- END Info Title -->
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php
                                ...
                                $myusername = stripslashes($myusername);
                                $myusername = mysql_real_escape_string($myusername);
                                $query="SELECT bio FROM $tbl_name WHERE username='$myusername'";
                                $result = mysql_query($query);
                                $row = mysql_fetch_row($result);
                                echo $row[0];
                                ob_end_flush();?></td>
